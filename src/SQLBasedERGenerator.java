...
/**
 * SQL-based ER Diagram Generator
 * Generates ER diagrams based on CREATE TABLE statements and JOIN relationships
 */
public class SQLBasedERGenerator {
    ...
    public static void main(String[] args) {
        try {
            if (args.length == 0) {
                System.out.println("Usage: java SQLBasedERGenerator <sql-file> [domain] [output-dir]");
                return;
            }
            ...
            System.out.println("=== SQL-based ER Diagram Generator ===");
            ...
            // Extract table structures from CREATE TABLE statements
            ...
            // Extract join relations from JOIN statements
            ...
            System.out.println("\nSQL-based ER Diagram generated successfully!");
    ...
    private static void generateMermaidER(Map<String, TableInfo> tables, List<TableRelation> relations, 
        ...
        mermaid.append("    %% ").append(domain).append(" Domain SQL-based ER Diagram\n");
        ...
        String filename = outputDir + "/" + domain + "-sql-based-er-diagram.mermaid";
    ...
    private static void generatePlantUMLER(Map<String, TableInfo> tables, List<TableRelation> relations, 
        ...
        plantuml.append("!define TITLE ").append(domain).append(" Domain SQL-based ER Diagram\n");
        ...
        String filename = outputDir + "/" + domain + "-sql-based-er-diagram.puml";
    ...
    private static void generateMarkdownReport(Map<String, TableInfo> tables, List<TableRelation> relations, 
        ...
        report.append("# ").append(domain).append(" Domain SQL-based ER Diagram Report\n\n");
        ...
        report.append("\n## Files Generated\n\n");
        report.append("- `").append(domain).append("-sql-based-er-diagram.mermaid` - Mermaid ER diagram (SQL-based)\n");
        report.append("- `").append(domain).append("-sql-based-er-diagram.puml` - PlantUML ER diagram (SQL-based)\n");
        report.append("- `").append(domain).append("-sql-based-er-report.md` - This comprehensive report\n");
        
        String filename = outputDir + "/" + domain + "-sql-based-er-report.md";
